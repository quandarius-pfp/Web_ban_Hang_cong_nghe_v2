       ...
       <table>
        ...
        ?>
            <tr>
                ...
                <?php if($row['add_sale'] == 0){ ?>
                
                
                    <a href="modules/quanlisale/xuli.php?idsanpham=<?php echo $row['id_sanpham'] ?>">Add</a>
               <?php }else{?>
                ...
                <?php } ?> </th>
                 ...
                 <?php if($row['add_sale'] == 1) {?>

                <th><a href="modules/quanlisale/xuli2.php?idsanpham=<?php echo $row['id_sanpham'] ?>" class="icon-a"><i class='bx bxs-message-alt-x'></i></a></th>
                <?php } ?>
              </tr>
       <?php 
           }}
