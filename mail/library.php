...
define("SMTP_UNAME", "devgamingshop@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "ztqheldshyzuuohf"); //Password for SMTP authentication
